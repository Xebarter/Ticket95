...
WHERE table_schema = 'public'
  ...
  AND table_name IN ('users', 'events', 'sponsors', 'orders', 'tickets', 'support_messages', 'notifications', 'platform_settings', 'affiliates', 'affiliate_commissions', 'payouts');
...
WHERE schemaname = 'public'
  AND tablename IN ('users', 'events', 'sponsors', 'orders', 'tickets', 'support_messages', 'notifications', 'platform_settings', 'affiliates', 'affiliate_commissions', 'payouts')
ORDER BY tablename;
...
WHERE trigger_schema = 'public'
  AND event_object_table IN ('users', 'events', 'sponsors', 'orders', 'tickets', 'support_messages', 'notifications', 'platform_settings', 'affiliates', 'affiliate_commissions', 'payouts')
...
SELECT 
  ...
  (SELECT COUNT(*) FROM information_schema.tables 
   ...
   AND table_name IN ('users', 'events', 'sponsors', 'orders', 'tickets', 'support_messages', 'notifications', 'platform_settings', 'affiliates', 'affiliate_commissions', 'payouts')) as tables_created,
  ...
  (SELECT COUNT(*) FROM pg_indexes 
   WHERE schemaname = 'public' 
   AND tablename IN ('users', 'events', 'sponsors', 'orders', 'tickets', 'support_messages', 'notifications', 'platform_settings', 'affiliates', 'affiliate_commissions', 'payouts')) as total_indexes;
